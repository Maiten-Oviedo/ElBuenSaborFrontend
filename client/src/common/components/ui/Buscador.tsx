...
const Buscador = () => {
  ...
  useEffect(() => {
    ...
    if (searchTerm.length > 0 && pathname !== '/menu') {
      router.push('/menu');
    }
  }, [searchTerm]);
    ...
    <StyledWrapper>
      <div className="container">
        ...
        <div className="mainbox">
          ...
          <input className="search_input" placeholder="Buscar" type="text" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
        </div>
      </div>
    </StyledWrapper>
  );
