...
export default function EditarRubro() {
  ...
  const id = params?.id
  const { data: categorias, getCategoriaById } =
      ...
      <div className="space-y-6 p-6">
        ...
        <div className="flex justify-center">
          <CategorySelector
            ...
            label="Nueva Categoría Padre (Opcional)"
            placeholder="Seleccionar nueva categoría padre o dejar vacío"
            error={categoryError}
          />
        </div>
        ...
        <div className="text-center text-gray-300 text-sm space-y-2">
          <p>🔍 Asegúrate de seleccionar la categoría padre correcta</p>
        </div>
      </div>
    </Modal>
  )
